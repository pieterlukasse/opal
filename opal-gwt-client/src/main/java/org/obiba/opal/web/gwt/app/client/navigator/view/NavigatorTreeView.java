...
public class NavigatorTreeView extends ViewImpl implements NavigatorTreePresenter.Display {
  ...
  public void selectVariable(TableDto table, VariableDto variable, boolean fireEvent) {
    ...
    breadcrumbs.add(new NavLink(variable.getName() + appendTypeLabel(translations.variableLabel())));
  }
  ...
  @Override
  public void selectTable(TableDto table, boolean fireEvents) {
    clear();
    breadcrumbs.add(getDatasourceLink(table.getDatasourceName()));
    breadcrumbs.add(getTableLink(table.getName() + appendTypeLabel(
        table.hasViewLink() ? translations.viewLabel() : translations.tableLabel())));
    if (fireEvents) {
  ...
  @Override
  public void selectDatasource(DatasourceDto datasource, boolean fireEvents) {
    clear();
    breadcrumbs.add(getDatasourceLink(datasource.getName() + appendTypeLabel(translations.datasourceLabel())));
  ...
  private String appendTypeLabel(String type) {
    return "";//" [" + type + "]";
  }
